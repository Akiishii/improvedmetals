...
import de.improvedmetals.common.tiles.TileCombinatorTier2;
...
public class ContainerCombinatorTier2 extends Container {
	...
	public ContainerCombinatorTier2(InventoryPlayer playerInv, IInventory forgeInventory) {
		...
		// Fuel slot
		addSlotToContainer(new SlotFurnaceFuel(forgeInventory, TileCombinatorTier2.SLOT_FUEL, 13, 42));

		// Output slot
		addSlotToContainer(
				new SlotCombinatorOutput(playerInv.player, forgeInventory, TileCombinatorTier2.SLOT_OUTPUT, 116, 35));
