...
public class ContainerCombinatorTier4 extends Container {
	...
	public ContainerCombinatorTier4(InventoryPlayer playerInv, IInventory forgeInventory) {
		...
		// Fuel slot
		addSlotToContainer(new SlotFurnaceFuel(forgeInventory, TileCombinatorTier4.SLOT_FUEL, 13, 42));

		// Output slot
		addSlotToContainer(
				new SlotCombinatorOutput(playerInv.player, forgeInventory, TileCombinatorTier4.SLOT_OUTPUT, 116, 35));
