...
public class ContainerCombinatorTier1 extends Container {
	...
	public ContainerCombinatorTier1(InventoryPlayer playerInv, IInventory forgeInventory) {
		...
		// Fuel slot
		addSlotToContainer(new SlotFurnaceFuel(forgeInventory, TileCombinatorTier1.SLOT_FUEL, 13, 42));

		// Output slot
		addSlotToContainer(
				new SlotCombinatorOutput(playerInv.player, forgeInventory, TileCombinatorTier1.SLOT_OUTPUT, 116, 35));
