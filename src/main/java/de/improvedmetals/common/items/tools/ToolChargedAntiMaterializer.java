...
public class ToolChargedAntiMaterializer extends ItemTool{
	...
	public static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.ACTIVATOR_RAIL, Blocks.COAL_ORE, Blocks.COBBLESTONE, Blocks.DETECTOR_RAIL, Blocks.DIAMOND_BLOCK, Blocks.DIAMOND_ORE,
            ...
            IMBlocks.IMPROVED_EMERALD_BLOCK, IMBlocks.IMPROVED_OBSIDIAN_BLOCK, IMBlocks.IMPROVED_GLOWSTONE_BLOCK, IMBlocks.WITHER_BLOCK, IMBlocks.DRAGON_BLOCK, IMBlocks.WITHER_OBSIDIAN, IMBlocks.DRAGON_OBSIDIAN,
            IMBlocks.COMBINATOR_TIER1, IMBlocks.COMBINATOR_TIER2, IMBlocks.COMBINATOR_TIER3, IMBlocks.COMBINATOR_TIER4, IMBlocks.SOLAR_TIER1, IMBlocks.SOLAR_TIER2, IMBlocks.SOLAR_TIER3, IMBlocks.SOLAR_TIER4,
            IMBlocks.SOLAR_TIER5, IMBlocks.SOLAR_TIER6, IMBlocks.SOLAR_TIER7, IMBlocks.SOLAR_TIER8, IMBlocks.SOLAR_TIER9, IMBlocks.SOLAR_TIER10);
