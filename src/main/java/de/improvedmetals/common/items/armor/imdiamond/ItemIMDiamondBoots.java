...
public class ItemIMDiamondBoots extends ItemArmor{

	public ItemIMDiamondBoots(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.IMDIAMOND_BOOTS){
