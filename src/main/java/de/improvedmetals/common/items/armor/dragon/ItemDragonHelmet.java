...
public class ItemDragonHelmet extends ItemArmor{

	public ItemDragonHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.DRAGON_HELMET){
