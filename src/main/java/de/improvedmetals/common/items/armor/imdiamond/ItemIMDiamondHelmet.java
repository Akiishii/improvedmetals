package de.improvedmetals.common.items.armor.imdiamond;
...
public class ItemIMDiamondHelmet extends ItemArmor{

	public ItemIMDiamondHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.IMDIAMOND_HELMET){
