package de.improvedmetals.common.items.armor.imemerald;
...
public class ItemIMEmeraldHelmet extends ItemArmor{

	public ItemIMEmeraldHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.IMEMERALD_HELMET){
