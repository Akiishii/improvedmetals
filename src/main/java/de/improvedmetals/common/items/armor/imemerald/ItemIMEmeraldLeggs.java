...
public class ItemIMEmeraldLeggs extends ItemArmor{

	public ItemIMEmeraldLeggs(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.IMEMERALD_LEGGS){
