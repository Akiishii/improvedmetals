package de.improvedmetals.common.items.armor.obsidian;
...
public class ItemObsidianLeggs extends ItemArmor{

	public ItemObsidianLeggs(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.OBSIDIAN_LEGGS){
