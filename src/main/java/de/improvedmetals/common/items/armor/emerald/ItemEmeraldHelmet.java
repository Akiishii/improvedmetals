package de.improvedmetals.common.items.armor.emerald;
...
public class ItemEmeraldHelmet extends ItemArmor{
	...
	public ItemEmeraldHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn, List<String> tooltip, boolean advanced) {
		...
		if(stack.getItem() == IMItems.EMERALD_HELMET){
