...
public class TileCombinatorTier2 extends TileEntity implements ITickable, ISidedInventory {

	public static final float BURN_TIME_MULTI = 1.5f;
	...
	public void smeltItem() {
		...
		if (canSmelt()) {
			...
			if (stacks[SLOT_OUTPUT] == null) {
				stacks[SLOT_OUTPUT] = output; // No need to copy, since output
												// is a copy, right?
			...
			// Consume ingredients
			CombinatorRecipe recipe = CombinatorRecipe.getMatchingRecipe(getInputStacks());
			CombinatorRecipeObject[] inputList = recipe.getInputs();
			for (CombinatorRecipeObject recipeObject : inputList) {
	...
	/*
	  ...
	  public boolean isItemValidForSlot(int index, ItemStack stack) {
	    ...
	    if (index == SLOT_FUEL) {
	      ...
	      return CombinatorRecipe.isValidIngredient(stack);
	    }
	  ...
	  public String getName() {
	    ...
	    return "container.naberius.hellforge.name";
	  }
	  ...
	  public Container createContainer(InventoryPlayer playerInventory, EntityPlayer player) {
	    ...
	    return new ContainerCombinatorTier2(playerInventory, this);
