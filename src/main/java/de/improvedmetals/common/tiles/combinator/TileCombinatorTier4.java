...
public class TileCombinatorTier4 extends TileEntity implements ITickable, ISidedInventory {

	public static final float BURN_TIME_MULTI = 3.5f;
	...
	/*
	  ...
	  public Container createContainer(InventoryPlayer playerInventory, EntityPlayer player) {
	    ...
	    return new ContainerCombinatorTier4(playerInventory, this);
