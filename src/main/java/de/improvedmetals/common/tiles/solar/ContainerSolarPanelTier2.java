...
public class ContainerSolarPanelTier2 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier2PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier2PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier2PanelPowerGen;
