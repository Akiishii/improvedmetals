...
public class ContainerSolarPanelTier8 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier8PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier8PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier8PanelPowerGen;
