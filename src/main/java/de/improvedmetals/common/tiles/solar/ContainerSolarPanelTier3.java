...
public class ContainerSolarPanelTier3 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier3PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier3PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier3PanelPowerGen;
