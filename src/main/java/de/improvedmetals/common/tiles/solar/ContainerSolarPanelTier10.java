...
public class ContainerSolarPanelTier10 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier10PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier10PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier10PanelPowerGen;
