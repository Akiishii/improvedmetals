...
public class ContainerSolarPanelTier9 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier9PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier9PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier9PanelPowerGen;
