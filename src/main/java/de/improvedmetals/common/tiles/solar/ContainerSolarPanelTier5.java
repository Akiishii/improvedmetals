...
public class ContainerSolarPanelTier5 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier5PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier5PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier5PanelPowerGen;
