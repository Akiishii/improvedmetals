...
public class ContainerSolarPanelTier4 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier4PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier4PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier4PanelPowerGen;
