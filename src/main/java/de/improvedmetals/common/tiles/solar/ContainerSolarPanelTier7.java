...
public class ContainerSolarPanelTier7 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier7PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier7PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier7PanelPowerGen;
