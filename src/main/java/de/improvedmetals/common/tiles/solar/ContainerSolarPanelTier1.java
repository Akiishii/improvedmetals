...
public class ContainerSolarPanelTier1 implements ITeslaHolder, ITeslaProducer, IEnergyStorage {
    ...
    public long takePower (long tesla, boolean simulated) {
        ...
        final long removedPower = Math.min(this.storedPower, Math.min(ConfigValues.tier1PanelTransferRate, tesla));
    ...
    public long getCapacity () {
        ...
        return ConfigValues.tier1PanelCapacity;
    }
    ...
    public void generatePower () {
        ...
        this.storedPower += ConfigValues.tier1PanelPowerGen;
