...
public class BlockCombinator extends BlockMachineBase{

	public BlockCombinator() {
		
		super(Material.ROCK, "blockCombinatorTier1");
		setRegistryName(ImprovedMetals.MODID, "blockCombinatorTier1");
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TileCombinatorTier1();
