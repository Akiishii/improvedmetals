package de.improvedmetals.common.lib.gui.widgets.slot;
...
public class SlotCombinatorOutput extends SlotFurnaceOutput {

	private EntityPlayer thePlayer;
	private int removeCount;

	public SlotCombinatorOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex,
	...
	protected void onCrafting(ItemStack stack) {
		...
		if (!this.thePlayer.worldObj.isRemote) {
			...
			CombinatorRecipe recipe = CombinatorRecipe.getRecipeByOutput(stack);
